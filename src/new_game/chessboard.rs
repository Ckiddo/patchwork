use bevy::prelude::*;
pub fn spawn_chessboard(commands: &mut Commands, pos_x: f32, pos_y: f32, color1: Color, color2: Color) {
    ...
    for row in 0..rows {
        for col in 0..cols {
            ...
            let x = col as f32 * square_size + square_size / 2.0 + pos_x - width / 2.0;
            let y = row as f32 * square_size + square_size / 2.0 + pos_y - width / 2.0;
